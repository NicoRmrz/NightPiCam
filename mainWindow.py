...
downButton_Path = Main_path + 'Icon_Image/downButton.png'
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.Video_Stream = QRPIVideoStreamThread(self.camera, self.rawCapture, self.RPICaptureThread )
       ...
       # self.Timer_Thread.start()
        ...
        # --------- Exit Button ------------
        # ----------------------------------
        self.btnExit = Exit_Button(self,"")
        self.btnExit.move(400,380)
        self.btnExit.setMaximumSize(QSize(65,55))
        self.btnExit.setStyleSheet(GUI_Style.startButton)
        self.btnExit.setIcon(QIcon(downButton_Path))
        self.btnExit.setIconSize(QSize(60,60))
        self.btnExit.setAutoDefault(False)
        self.btnExit.pressed.connect(self.on_btnExit_clicked)
