...
while True:
    ...
    adc1 = accel.adc_reading(1)
    adc2 = accel.adc_reading(2)
    adc3 = accel.adc_reading(3)
                    
    print ('x: '+str(x)+' y: '+str(y)+' z: '+str(z) +' |' + ' ADC1: ' + str(adc1)+ ' ADC2: '+str(adc2)+ ' ADC3: '+ str(adc3)+' | Temp: '+str(accel.get_temperature())+' C') 
